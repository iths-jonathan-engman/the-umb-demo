...
public class IndexComponent(IExamineManager examineManager, IUmbracoContextFactory umbracoContextFactory) : IComponent
{
    public void Initialize()
    {
        ...
        index.TransformingIndexValues += UmbracoContextIndex_TransformingIndexValue;
    }

    public void Terminate()
    { }

    private void UmbracoContextIndex_TransformingIndexValue(object? sender, IndexingItemEventArgs e)
    {
